...
a persistence unit "EvaluacionWSaraujoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSaraujo\pom.xml":
...
artifact ("EvaluacionWSaraujo.war") is already built. You can build
